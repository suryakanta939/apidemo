...
public class AndroidGesture {
	...
	public static void tapOnELement(AndroidDriver<AndroidElement> driver,AndroidElement element) {
		
	}
	public static void dragAndDrop(AndroidDriver<AndroidElement> driver,AndroidElement srcElement,AndroidElement dstElement){
		TouchAction act=new TouchAction(driver);
		act.longPress(srcElement).waitAction(Duration.ofSeconds(3)).moveTo(dstElement).release().perform();
	}
